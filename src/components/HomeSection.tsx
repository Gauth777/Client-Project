...
export default function HomeSection({ onNavigate }: HomeSectionProps) {
  return (
    <div
      ...
      className='relative space-y-20 overflow-hidden pb-16'
    >
      ...
      <div id='home-hero-composition' className='relative z-10'>
          ...
          <div className='relative mx-auto max-w-7xl px-4 py-10 sm:px-6 sm:py-14 lg:px-8 lg:py-16'>
            <div className='grid items-center gap-8 lg:grid-cols-[minmax(0,1.05fr)_minmax(420px,0.95fr)] lg:gap-4 xl:gap-8'>
              <div className='max-w-3xl pt-2 lg:pt-5'>
                ...
                >
                  A colorful journey — carefully selected rice, traditional
                  values, and the warmth of a freshly cooked meal at home.
                </motion.p>
        ...
        <section
          id='home-agrarian-landscape'
          className='relative w-full bg-[#f8f7f0]'
        >
      ...
      <section
        id='home-intro-about'
        className='relative z-10 mx-auto grid max-w-7xl grid-cols-1 items-center gap-12 px-4 sm:px-6 lg:grid-cols-12 lg:px-8'
      >
        <div className='space-y-6 lg:col-span-5'>
          ...
          <p className='text-sm leading-relaxed text-stone-600'>
            Sri Kannika Parameswari Modern Rice Mill brings together local
            agricultural knowledge and disciplined processing to deliver
            consistent rice for homes, retailers and commercial kitchens.
          </p>
          <p className='text-sm leading-relaxed text-stone-600'>
            From paddy selection and cleaning to sorting and packaging, each
            stage is handled with attention to grain quality, hygiene and
            reliable supply.
          </p>
          <button
        ...
        <div className='grid grid-cols-2 gap-4 lg:col-span-7'>
          <div className='space-y-4'>
            ...
            <div className='space-y-2 rounded-xl bg-emerald-900 p-6 text-emerald-100'>
              <span className='block font-serif text-lg font-bold text-white'>
                Regional Paddy Selection
              </span>
              <span className='block text-[11px] leading-relaxed text-emerald-300'>
                Paddy is selected with close attention to variety, condition and
                suitability for consistent milling.
              </span>
            </div>
          </div>
          <div className='space-y-4 pt-8'>
            <div className='space-y-2 rounded-xl bg-amber-600 p-6 text-amber-50'>
              <span className='block font-serif text-lg font-bold text-white'>
                Modern Grain Sorting
              </span>
              <span className='block text-[11px] leading-relaxed text-amber-100'>
                Optical sorting supports cleaner, more uniform grains across
                finished batches.
              </span>
            </div>
            <div className='aspect-[4/5] overflow-hidden rounded-xl border border-stone-200 bg-stone-100 shadow-md'>
      ...
      <section
        ...
        className='relative z-10 mx-auto max-w-7xl space-y-12 px-4 sm:px-6 lg:px-8'
      >
        ...
        <div className='grid grid-cols-1 gap-8 sm:grid-cols-3'>
          {[
            ...
            >
              ...
              <p className='mx-auto max-w-xs text-xs leading-relaxed text-stone-600'>
                {text}
              </p>
            </motion.div>
          ))}
        ...
        <div className='relative overflow-hidden rounded-[28px] border border-emerald-900 bg-emerald-950 p-7 text-white shadow-xl sm:p-10'>
          ...
          <div className='relative z-10 text-center'>
            ...
            <p className='mx-auto mt-3 max-w-xl text-xs leading-relaxed text-emerald-200/90 sm:text-sm'>
              Select any review to open the mill’s Google Business listing and
              view the public feedback directly.
            </p>
          </div>
