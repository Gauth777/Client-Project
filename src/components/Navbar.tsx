      ...
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <span className="hidden min-w-0 sm:block">
            ...
            <span className="mt-0.5 block text-[9px] font-semibold uppercase tracking-[0.22em] text-amber-700 md:text-[10px]">
              Modern Rice Mill
            </span>
          </span>
        </button>
              ...
              {NAV_ITEMS.map((item, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span className={`text-xs ${isActive ? 'text-amber-300' : 'text-stone-300'}`}>
                      0{index + 1}
                    </span>
                  </button>
                );
